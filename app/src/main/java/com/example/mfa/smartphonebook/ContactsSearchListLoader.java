...
public class ContactsSearchListLoader extends AsyncTaskLoader<List<Contact>> {
    ...
    public List<Contact> loadInBackground() {
        ...
        String selection =PhoneContract.ContactsColumn.CONTACT_NAME + " LIKE '%" + mFilterText+ "%'";
        mCursor=mContentResolver.query(PhoneContract.URI_TABLE,projection,selection,null,null);
        if(mCursor!=null){
